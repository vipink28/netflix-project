      ...
      <div className="caption">
        ...
        <p>
          {details.data?.genres.map((item) => {
            return (
             <GenreLink key={item.id} genre={item} type={type}/>
            );
          })}
        </p>
        ...
        <button className="btn btn-warning mt-3" data-bs-toggle="modal" data-bs-target="#videoDetails" onClick={getDetails}>More Info</button>
